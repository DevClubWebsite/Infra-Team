...
function pe() {
  return React$1.useContext(ce) || de;
}

function fe() {
  return React$1.useContext(le) || he;
}
...
var Ce = /invalid hook call/i,
  ...
  if ("production" !== process.env.NODE_ENV) {
    ...
    try {
      ...
      }, React$1.useRef(), o && !Ie.has(n) && (console.warn(n), Ie.add(n));
    } catch (e) {
  ...
  var C,
    ...
    return function (e, t, n, r) {
      var o = e.attrs,
          ...
          p = e.target;
      "production" !== process.env.NODE_ENV && React$1.useDebugValue(h);
      ...
      var m = function (e, t, n) {
      ...
      }(Oe(t, React$1.useContext(Me), a) || w, t, o),
          v = m[0],
          g = m[1],
          S = function (e, t, n, r) {
        var o = pe(),
        ...
        return "production" !== process.env.NODE_ENV && React$1.useDebugValue(i), "production" !== process.env.NODE_ENV && !t && r && r(i), i;
      ...
      return t.style && g.style !== t.style && (C.style = y({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = b, /*#__PURE__*/React$1.createElement(_, C);
    }(C, e, t, P);
  };
...
function $e(e) {
  ...
  function l(e) {
    var t = pe(),
        n = fe(),
        o = React$1.useContext(Me),
        u = React$1.useRef(t.allocateGSInstance(a)).current;
...
function ButtonCTA({
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(GlobalStyles, null), /*#__PURE__*/React__default["default"].createElement(StyledButtonCTA, {
    size: size
  }, /*#__PURE__*/React__default["default"].createElement("p", null, label), /*#__PURE__*/React__default["default"].createElement(ArrowDiv, {
    size: size
...
function Navbar({
  ...
  const [focusedElement, setFocusedElement] = React$1.useState();
...
function Typography({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GlobalStyles, null), /*#__PURE__*/React.createElement(StyledTypography, {
    weight: weight,
    variant: variant,
    color: color
  }, label));
...
function Card({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GlobalStyles, null), /*#__PURE__*/React.createElement(StyledCard, {
    width: width,
    height: height,
    color: color,
    border: border
